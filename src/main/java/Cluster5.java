...
//        Admin hAdmin = connection.getAdmin();
        ...
        String s1 = "1369000080318070787";
        String s2 = "1366000015534153728";
        String s3 = "1379000299835232257";
        String s4 = "1380000057508892673";
        String s5 = "1348000011880173570";
        origins.add(s1);
        origins.add(s2);
        origins.add(s3);
        origins.add(s4);
        ...
        config.set("origins3", s4);
        config.set("origins4", s5);
        for (int idx = 0; idx < 1; idx ++) {
            ...
            job.setJarByClass(Cluster5.class);
            ...
            job2.setJarByClass(Cluster5.class);
